...
public class DateTimeUtils {
    ...
    public static final DateTimeFormatter DATE_TIME_ATTER = DateTimeFormatter.ofPattern("yyyy-MM-dd HH:mm:ss");
    ...
    /**
     * 返回当前时间  yyyyMMdd HH:mm:ss
     * @return
     */
    public static String getCurrentNowDate() {
        return LocalDateTime.now().format(DATE_TIME_ATTER);
    }
    /**
     * yyyyMMdd
     *
